...
import xTop_android from './顶部_android.png';
...
export default (
  ...
  <>
    ...
    <div style={{ flex: 'none', position: 'relative' }}>
      <img src={xBottom} style={{ width: '100%', objectFit: 'contain' }} onClick={event => event.stopPropagation()} />
      {!loading && !endCard && (
    ...
    <img
      src={onAndroid ? xTop_android : xTop}
      style={{
        width: '100%',
        objectFit: 'contain',
        position: 'absolute',
